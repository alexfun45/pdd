    ...
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        var body = '<ul class="nav note-nav nav-tabs note-nav-tabs">' +
                      '<li class="nav-item note-nav-item active"><a onclick="return false;" class="nav-link note-nav-link active" href="#note-imageAttributes-link-' + i + '" data-toggle="tab">' + lang.imageAttributes.tabLink + '</a></li>';
        //if (options.imageAttributes.disableUpload == false) {
           //body +=    '<li class="nav-item note-nav-item"><a onclick="return false;" class="nav-link note-nav-link" href="#note-imageAttributes-upload-' + i + '" data-toggle="tab">' + lang.imageAttributes.tabUpload + '</a></li>';
        //}
        body +=     '</ul>' +
                    '<div class="tab-content">' +
// Tab 3
                    '<div class="tab-pane note-tab-pane fade in active" id="note-imageAttributes-link-' + i + '">' +
